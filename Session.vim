...
set shortmess=aoO
badd +0 src/task/taskMgr.cpp
badd +0 src/task/taskMgr.h
badd +0 src/util/myMinHeap.h
badd +0 src/util/myHashSet.h
argglobal
silent! argdel *
argadd src/task/taskMgr.cpp
set stal=2
